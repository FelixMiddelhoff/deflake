...
Culprit starts `dotnet test` on projects you point it at, so it runs the code
...
[GitHub security advisories](https://github.com/FelixMiddelhoff/culprit/security/advisories/new)
